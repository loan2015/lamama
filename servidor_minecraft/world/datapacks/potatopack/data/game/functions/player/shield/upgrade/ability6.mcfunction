...
scoreboard players set ability6 game 1
clear @s shield{shield_upgrade:6}
team join friendly @s
tellraw @a [{"selector":"@s"},{"translate":"notify.ability.unlocked"}]
team join friendly_player @s
tellraw @a {"translate":"custom_shield.lore13_unlocked","hoverEvent":{"action":"show_text","value":[{"translate":"custom_shield.lore14_unlocked"}]}}
