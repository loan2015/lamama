...
scoreboard players set ability1 game 1
clear @s shield{shield_upgrade:1}
team join friendly @s
tellraw @a [{"selector":"@s"},{"translate":"notify.ability.unlocked"}]
team join friendly_player @s
tellraw @a {"translate":"custom_shield.lore3_unlocked","hoverEvent":{"action":"show_text","value":[{"translate":"custom_shield.lore4_unlocked"}]}}
