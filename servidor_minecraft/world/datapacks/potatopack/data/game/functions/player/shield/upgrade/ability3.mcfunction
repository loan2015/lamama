...
scoreboard players set ability3 game 1
clear @s shield{shield_upgrade:3}
team join friendly @s
tellraw @a [{"selector":"@s"},{"translate":"notify.ability.unlocked"}]
team join friendly_player @s
tellraw @a {"translate":"custom_shield.lore7_unlocked","hoverEvent":{"action":"show_text","value":[{"translate":"custom_shield.lore8_unlocked"}]}}
