...
execute unless score @s spawner_tweaker_slot = @s spawner_tweaker_slot_prev run tag @s remove holding_spawner
execute unless score @s spawner_tweaker_slot = @s spawner_tweaker_slot_prev run scoreboard players set holding_spawner spawner_tweaker 0
